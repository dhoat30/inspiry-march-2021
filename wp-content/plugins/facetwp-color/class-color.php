...
class FacetWP_Facet_Color_Addon extends FacetWP_Facet
{
    ...
    function load_values( $params ) {
        ...
        // Orderby
        $orderby = 'f.depth, counter DESC, f.facet_display_value ASC';
    ...
    function render( $params ) {
        ...
        foreach ( $values as $result ) {
            ...
            $item = '<div class="facetwp-color' . $selected . '" data-value="' . $result['facet_value'] . '" data-color="' . esc_attr( $result['facet_display_value'] ) . '"></div>';
