							...
							{                                                               
								...
								if(data.finished==1)
								{
                                                                    ...
                                                                    $.each(data.log_data, function (j) {
                                                                                var status_icon = (data.log_data[j].status == true ) ? 'yes' : 'no';
										...
										$('#wt_iew_import_progress tbody').append( '<tr id="row-' + data.log_data[j].row + '" class="' + data.log_data[j].status + '"><td><span class="result" title="' + data.log_data[j].row + '">' + data.log_data[j].row + '</span></td><td class="row">' + item_name + '</td><td>' + data.log_data[j].message + '</td><td class="reason"><span class="dashicons dashicons-'+status_icon+'"></span></td></tr>' );
                                                                                newk = j;
                                                                    });
                                                                    $('.wt-iew-importer-progress').val(data.total_percent);
                                                                    document.getElementById('row-' + ( newk )).scrollIntoView(false);                                                                  
                                                                    $('.wt-iew-importer-progress').hide();
