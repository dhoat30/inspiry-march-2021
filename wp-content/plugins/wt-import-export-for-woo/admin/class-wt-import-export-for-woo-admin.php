	...
	public function enqueue_scripts()
	{
		...
		$params=array(
			...
			'msgs'=>array(
				...
				'use_expression'=>__('Use expression as value', 'wt-import-export-for-woo'),
	...
	*/
	public function save_settings()
	{
		...
		if(Wt_Iew_Sh::check_write_access(WT_IEW_PLUGIN_ID)) 
    	{
			...
			$checkbox_items = array( 'wt_iew_enable_import_log', 'wt_iew_enable_history_auto_delete', 'wt_iew_enable_export_code', 'wt_iew_enable_speed_mode' );
