...
?>
	<div class="ywgc-product-edit-page-options yith-plugin-ui options_group">

		<div class="show_if_gift-card yith-plugin-ui ywgc-product-edit-page-amount-options">
		...
		<div class="show_if_gift-card yith-plugin-ui ywgc-product-edit-page-multi-currency-options">
			<?php do_action( 'yith_ywgc_multi_currency_settings', $thepostid );?>
		</div>

		<div class="show_if_gift-card yith-plugin-ui ywgc-product-edit-page-after-amount-options">
